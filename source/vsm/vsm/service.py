...
service_opts = [
    ...
    cfg.StrOpt('vsmapi_storage_listen',
               default="0.0.0.0",
               help='IP address for OpenStack Energy API to listen'),
    cfg.IntOpt('vsmapi_storage_listen_port',
               default=8778,
               help='port for os energy api to listen'),
