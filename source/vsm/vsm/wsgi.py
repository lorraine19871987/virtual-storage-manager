...
class Server(object):
    ...
    def start(self, backlog=128):
        ...
        :returns: None
        :raises: vsm.exception.InvalidInput
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = vsm.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import vsm.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = vsm.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import vsm.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `vsm.exception.PasteAppNotFound`
