...
global_opts = [
    ...
    cfg.BoolOpt('enable_v1_api',
                default=True,
                help=("Deploy v1 of the Vsm API. ")),
    cfg.BoolOpt('enable_v2_api',
                default=True,
                help=("Deploy v2 of the Vsm API. ")),
...
vsm_settings_opts = [
    ...
    cfg.IntOpt('ceph_near_full_threshold',
               default=75,
               help='ceph near full threshold'),
    cfg.IntOpt('ceph_full_threshold',
               default=90,
               help='ceph full threshold'),
    cfg.IntOpt('pg_count_factor',
               default=100,
               help='pg count factor'),
    cfg.IntOpt('heartbeat_interval',
               default=5,
               help='heartbeat interval'),
    cfg.IntOpt('osd_heartbeat_interval',
               default=10,
               help='osd heartbeat interval'),
    cfg.IntOpt('osd_heartbeat_grace',
               default=10,
               help='osd heartbeat grace'),
    cfg.IntOpt('disk_near_full_threshold',
               default=75,
               help='disk near full threshold'),
    cfg.IntOpt('disk_full_threshold',
               default=90,
               help='disk full threshold'),
    cfg.IntOpt('osd_pool_default_size',
               default=3,
               help='osd pool default size'),
...
cache_tier_opts = [
    cfg.IntOpt('ct_hit_set_count',
               default=1,
               help='cache tier hit set count'),
    cfg.IntOpt('ct_hit_set_period_s',
               default=3600,
               help='cache tier hit set period second'),
    cfg.IntOpt('ct_target_max_mem_mb',
               default=1000000,
               help='cache tier target max mem mb'),
    cfg.FloatOpt('ct_target_dirty_ratio',
               default=0.4,
               help='cache tier target dirty ratio'),
    cfg.FloatOpt('ct_target_full_ratio',
                 default=0.8,
                 help='cache tier target full ratio'),
    cfg.IntOpt('ct_target_max_objects',
               default=1000000,
               help='cache tier target max objects'),
    cfg.IntOpt('ct_target_min_flush_age_m',
               default=10,
               help='cache tier target min flush age m'),
    cfg.IntOpt('ct_target_min_evict_age_m',
               default=20,
               help='cache tier target min evict age m')
]

FLAGS.register_opts(cache_tier_opts)
