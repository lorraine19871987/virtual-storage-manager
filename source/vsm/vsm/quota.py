...
quota_opts = [
    cfg.IntOpt('quota_storages',
               default=10,
               help='number of storages allowed per project'),
    cfg.IntOpt('quota_snapshots',
               default=10,
               help='number of storage snapshots allowed per project'),
    cfg.IntOpt('quota_gigabytes',
               default=1000,
               help='number of storage gigabytes (snapshots are also included) '
                    'allowed per project'),
    ...
    cfg.StrOpt('quota_driver',
               default='vsm.quota.DbQuotaDriver',
...
class BaseResource(object):
    ...
    def __init__(self, name, flag=None):
        ...
        :param name: The name of the resource, i.e., "storages".
...
class ReservableResource(BaseResource):
    ...
    def __init__(self, name, sync, flag=None):
        ...
        correspond to objects in the database, i.e., storages, gigabytes,
...
def _sync_storages(context, project_id, session):
    (storages, gigs) = db.storage_data_get_for_project(context,
                                                     project_id,
                                                     session=session)
...
def _sync_gigabytes(context, project_id, session):
    (_junk, vol_gigs) = db.storage_data_get_for_project(context,
                                                       project_id,
                                                       session=session)
...
resources = [
    ReservableResource('storages', _sync_storages, 'quota_storages'),
